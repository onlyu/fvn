...
{
  printf("usage:upload_file [-u username -p passwd] -l localfile [-r remotefie] -U url\n");
  printf("or:upload_file [--user username --passwordd passwd] --local-file localfile [--remote-file remotefile] --url url\n");
  exit(FAILED);
  return;
}
